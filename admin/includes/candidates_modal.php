        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Ảnh Đại Diện</label>
                ...
                <div class="form-group">
                    <label for="platform" class="col-sm-3 control-label">Thông tin ứng cử viên</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>CHỈNH SỬA PHIẾU BẦU</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Chức vụ</label>
                ...
                <div class="form-group">
                    <label for="edit_platform" class="col-sm-3 control-label">Thông tin ứng cử viên</label>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_delete.php">
                ...
                <div class="text-center">
                    <p>Bạn muốn xóa phiếu bầu ứng cử viên</p>
